    ...
    <div>
        <div class="container  py-4">
            <div className="row  feature-row">
                <div className="col-md-6 col-lg-6 p-3 wow fadeIn " data-wow-delay="0.1s">
                ...
                <div class="col-md-6 col-lg-6 p-3 wow fadeIn" data-wow-delay="0.3s">
                <div className="row p-4 container-card " >
                      <div className="col ">
                      <img src={menu2} className='img-fluid'></img>
                      </div>
                      <div className="col">
                      <h6 class="mb-3 ">Crema Di Pomodoro -<span className="text-danger">34$</span></h6>
                        <p class="mb-0">Chinese mustard/Chipotle aiol</p>
                      </div>
                    </div>
                </div>
            ...
            <div className="row  feature-row mt-2 py-2">
                <div className="col-md-6 col-lg-6 p-3 wow fadeIn " data-wow-delay="0.1s">
                    <div className="row p-4 container-card">
                      <div className="col">
                      <img src={menu5} className='img-fluid'></img>
                      </div>
                      <div className="col">
                      <h6 class="mb-3">Oatmeal Cookie  - <span className="text-danger">23$</span></h6>
                        <p class="mb-0">Chinese mustard/Chipotle aiol</p>
                      </div>
                    </div>
                ...
                <div className="row p-4 container-card " >
                      ...
                      <div className="col">
                      <h6 class="mb-3 ">Seasonal Soup -<span className="text-danger">14$</span></h6>
                        <p class="mb-0">Chinese mustard/Chipotle aiol</p>
                      </div>
                    </div>
                </div>
            ...
            <div className="row  feature-row mt-2 py-2">
                <div className="col-md-6 col-lg-6 p-3 wow fadeIn " data-wow-delay="0.1s">
                    <div className="row p-4 container-card">
                      <div className="col">
                      <img src={menu7} className='img-fluid'></img>
                      </div>
                      <div className="col">
                      <h6 class="mb-3">Insalata Rucola  - <span className="text-danger">33$</span></h6>
                        <p class="mb-0">Chinese mustard/Chipotle aiol</p>
                      </div>
                    </div>
                ...
                <div className="row p-4 container-card " >
                      <div className="col ">
                      <img src={menu8} className='img-fluid'></img>
                      </div>
                      <div className="col">
                      <h6 class="mb-3 ">Carpacio  -<span className="text-danger">84$</span></h6>
                        <p class="mb-0">Chinese mustard/Chipotle aiol</p>
                      </div>
                    </div>
                </div>
